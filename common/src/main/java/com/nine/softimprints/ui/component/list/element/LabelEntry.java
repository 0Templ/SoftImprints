...
public class LabelEntry extends AbstractConfigListEntry {
    ...
    public LabelEntry(int gap, Component text, int labelColor, int labelColorHovered) {
    ...
    public LabelEntry(int gap, Component text, @Nullable Runnable onClickAction) {
        this(gap, text, null, onClickAction);
    }

    public LabelEntry(int gap, Component text, @Nullable Component tooltip, @Nullable Runnable onClickAction) {
    ...
    public static LabelEntry singleLine(int gap, Component text) {
        return singleLine(gap, text, null, null);
    }

    public static LabelEntry singleLine(int gap, Component text, @Nullable Component tooltip) {
