...
public record BoxSkin(
	...
	public static final class Builder {
		...
		public Builder corners(UIRegion topLeft, UIRegion topRight, UIRegion botLeft, UIRegion botRight) {
		...
		public Builder edges(UIRegion top, UIRegion bottom, UIRegion left, UIRegion right) {
			this.top = top;
			this.bottom = bottom;
			this.left = left;
			this.right = right;
