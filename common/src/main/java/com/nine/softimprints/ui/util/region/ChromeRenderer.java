...
public final class ChromeRenderer {
    ...
    public static void leftDivider(
            GuiGraphicsExtractor graphics,
            int x,
            int y,
            int height
    ...
    public static void rightDivider(
            GuiGraphicsExtractor graphics,
            int x,
            int y,
            int height
    ...
    public static void sectionBorder(
            GuiGraphicsExtractor graphics,
            int x,
            int y,
            int width,
