package com.nine.softimprints.client.ui.component.slider;

import com.nine.softimprints.client.ui.util.KeyMods;
...
public class ExtendedSlider extends AbstractSliderButton {
	...
	public static final class Builder {
		...
		public Builder step(double stepSize, int precision) {
